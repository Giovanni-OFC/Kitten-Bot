...
let noetiqueta = 'https://qu.ax/ZlNo.jpg'
...
if (media === 'texto') return await this.sendMessage(m.chat, {text: ['*QUE YO QUE?*'].getRandom()}, {quoted: m, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})}
return !0 }
