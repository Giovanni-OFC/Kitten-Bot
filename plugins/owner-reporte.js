...
• wa.me/${m.sender.split`@`[0]}\n𝘙𝘦𝘱𝘰𝘳𝘵𝘦 𝘥𝘦 𝘦𝘳𝘳𝘰𝘳𝘦𝘴...`;
  conn.reply(':51902855352@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, {contextInfo: {mentionedJid: [m.sender]}});
  conn.reply('51917161566@s.whatsapp.net', m.quoted ? teks + m.quoted.text : teks, null, {contextInfo: {mentionedJid: [m.sender]}});
