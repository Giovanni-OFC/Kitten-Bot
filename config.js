...
global.fakegif3 = { key: { participant: `0@s.whatsapp.net`, ...(false ? { remoteJid: "5219992095479-1625305606@g.us" } : {}) }, message: { videoMessage: { title: 'Kitten', h: `Hmm`, seconds: '99999', gifPlayback: true, caption: '⚘݄𖠵༈𝙺 𝙸 𝚃 𝚃 𝙴 𝙽 ♡', jpegThumbnail: catalogo }}};
